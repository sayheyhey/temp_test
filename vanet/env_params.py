TIME_SLOT = 1  # s
REQUEST_DENSE = 20  # request per TIME_SLOT

ZIPF_BELTA = 0.98  # larger belta introduces more skewed content popularity distribution
KERNEL_ALPHA = 0.6  # relect the average cosine similarity among vehicles
CONTENT_LIBRARY_SIZE = 200  # num of different content files
ENCODED_SEGMENTS_UNITS_MAX, ENCODED_SEGMENTS_UNITS_MIN = 1, 0
...
VEH_CACHE_SIZE, RSU_CACHE_SIZE = 3 * (int(ENCODED_SEGMENTS_UNITS_MID * SEGMENT_UNIT_SIZE_MID)), 15 * (int(ENCODED_SEGMENTS_UNITS_MID * SEGMENT_UNIT_SIZE_MID))  # pyht
VEH_RANGE, RSU_RANGE, MBS_RANGE = 50, 200, 5000  # m
...
VEH_X_MAX, VEH_X_MIN, VEH_Y_MAX, VEH_Y_MIN = 1400, 600, 1440, 700
VEH_CUR_REQUEST_CNT_MAX = 40
